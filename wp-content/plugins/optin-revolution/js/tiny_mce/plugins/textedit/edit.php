...
<title>Text Editing and Formatting</title>
  ...
  <script type="text/javascript" src="js/textedit.js?t=<?php echo optinrev_cid();?>"></script>
  <script type="text/javascript">
    jQuery(document).ready(function($){
      tinyMCE.init({ theme: 'advanced', mode : 'none', elements: 'mce_textedit', plugins: 'paste,lineheight', theme_advanced_buttons1 : "fontselect,fontsizeselect,forecolor,backcolor,|,lineheight,|,bold,italic,underline,separator,strikethrough,bullist,numlist,undo,redo,link,unlink",theme_advanced_buttons2 : "",theme_advanced_buttons3 : "",theme_advanced_toolbar_location : "top",theme_advanced_toolbar_align : "left",theme_advanced_path : false,invalid_elements : 'p',cleanup : true,force_br_newlines : true,force_p_newlines : false,forced_root_block : '',remove_redundant_brs : false,remove_linebreaks : true,theme_advanced_font_sizes : "8pt,10pt,12pt,14pt,18pt,24pt,30pt,36pt,48pt,60pt,72pt",content_css : "<?php echo OPTINREV_DIR;?>/optinrev-css.php", paste_text_sticky : true, setup : function( ed ) {ed.onInit.add( function(ed, e) { ed.pasteAsPlainText = true; ed.dom.hide('mceDeleteObj');});}});
      //loading    
