...
<div id="nmuploader-wrapper">
		...
		<li>
			<ul>
				<li id="prev-page"><a href="javascript:loadUploaderPagePrev()">
						&laquo; <?php _e('Previous', $repo -> plugin_shortname)?>
				</a></li>
				<li id="page-count">2 of 11</li>
				<li id="next-page"><a href="javascript:loadUploaderPageNext()"> <?php _e('Next', $repo -> plugin_shortname)?>
						&raquo;
				</a></li>
			</ul>
		</li>
	...
	<script type="text/javascript">
			total_pages = <?php echo $repo -> total_pages?>;
