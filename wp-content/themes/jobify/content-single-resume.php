<?php if ( resume_manager_user_can_view_resume( $post->ID ) ) : ?>
	<div class="single-resume-content">
		...
		<div class="resume-aside">
			...
			<?php if ( $resume_file = get_post_meta( $post->ID, '_resume_file', true ) ) : ?>
				<a rel="nofollow" href="<?php echo esc_url( $resume_file ); ?>" class="resume-file resume-file-<?php echo substr( strrchr( $resume_file, '.' ), 1 ); ?>"><?php _e( 'Resume', 'jobify' ); ?></a>
			<?php endif; ?>
