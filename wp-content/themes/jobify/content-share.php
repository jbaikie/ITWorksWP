...
$fbmessage = $_SERVER[ "HTTP_HOST" ] . $_SERVER[ "REQUEST_URI" ];
?>
<div class="entry-share">
	<span class="entry-share-link">
		<div class="share-popup">
			...
			<a target="_blank" href="<?php printf( 'http://www.facebook.com/sharer.php?u=%s', $fbmessage ); ?>"><i class="icon-facebook"></i></a>
